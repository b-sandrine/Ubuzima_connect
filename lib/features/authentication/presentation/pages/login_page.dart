...
class _LoginViewState extends State<_LoginView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: AppGradientBackground(
        child: SafeArea(
          child: _selectedRole == UserRole.communityHealthWorker
              ? const ChwLoginView()
              : _GenericLoginView(role: _selectedRole!),
        ),
      ),
    );
  }
...
class _GenericLoginView extends StatefulWidget {
  final UserRole role;

  const _GenericLoginView({required this.role});

  @override
  State<_GenericLoginView> createState() => _GenericLoginViewState();
}

class _GenericLoginViewState extends State<_GenericLoginView> {
