...
Scheduling between Patients and Doctors (or CHW-arranged visits), including availability, reminders, and status lifecycle (requested / confirmed / completed / cancelled).
