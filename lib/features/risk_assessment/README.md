...
AI-assisted risk scoring collected by CHWs in the field — the assessment entity, scoring/business rules, and the referral trigger when a score crosses a threshold.
