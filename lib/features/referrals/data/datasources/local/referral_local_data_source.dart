    ...
    return const ReferralBoard(
      ...
      referrals: [
        ...
        Referral(
          ...
          status: ReferralStatus.pending,
          facility: 'CHUK',
          receivedLabel: 'Sent 2 days ago',
          referringPhysician: 'You',
          referringFacility: 'This facility',
          reason:
              'Declining eGFR (44 → 39) over 3 months. Requesting nephrology '
              'review and CKD staging.',
          clinicalSummary: 'eGFR 39 · Creatinine 182 · K+ 5.4 · BP 156/94',
          requestedTimeline: 'Within 2 weeks',
          timelineIsUrgent: false,
        ),
        Referral(
          reference: 'RW-REF-0031',
        ...
        Referral(
          reference: 'RW-REF-0029',
          specialty: 'Cardiology',
          urgency: ReferralUrgency.pending,
          direction: ReferralDirection.followUp,
          status: ReferralStatus.accepted,
          facility: 'CHC Kigali',
