...
CHW-to-Doctor (or Doctor-to-Doctor) patient referrals, typically triggered by a risk_assessment result, with status tracking through acceptance and resolution.
